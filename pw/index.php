...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="#">NovelMarket</a>
        ...
        <div class="col-md-3 col-sm-6 my-3 my-md-0">
            <form action="index.php" method="post">
                <div class="card shadow" style="width: 16rem;">
                    <img src="img/<?= $bk["gambar"]; ?>" alt="" class="img-fluid card-img-top">
                </div>
                <div class="card-body">
                    <h5 class="card-title"><?= $bk["nama_buku"]; ?></h5>
                    <h6>
                        <span class="pengarang"><b>Author : </b><?= $bk["pengarang"]; ?></span>
                    </h6>
                    <h6>
                        <span class="genre_buku "><b>Genre : </b><?= $bk["genre_buku"]; ?></span>
                    </h6>
                    <h6><span class="penerbit"><b>Publisher : </b><?= $bk["penerbit"]; ?></span></h6>
                    <h6><span class="thn_terbit"><b>Years : </b><?= $bk["thn_terbit"]; ?></span></h6>
...
<footer class="footer-distributed">
			...
			<div class="footer-left">
				...
				<p class="footer-company-name">Novel Market © 2021</p>
			</div>
